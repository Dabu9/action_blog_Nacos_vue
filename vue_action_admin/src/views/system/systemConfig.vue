    ...
    <el-tabs v-model="activeName" type="border-card" @tab-click="handleClick">
      <el-tab-pane v-permission="'/systemConfig/getSystemConfig'" name="one">
        ...
        <el-form style="margin-left: 20px;" label-position="left" label-width="140px" >
          ...
          <el-form-item>
            <el-button v-permission="'/systemConfig/editSystemConfig'" type="primary" @click="submitForm()">保 存</el-button>
          </el-form-item>
      ...
      <el-tab-pane v-permission="'/systemConfig/getSystemConfig'" name="four">
        ...
        >
          ...
          <el-form-item label="七牛云私钥">
            <el-input v-model="form.qiNiuSecretKey" type="password" auto-complete="new-password" style="width: 400px"/>
          </el-form-item>
      ...
      <el-tab-pane v-permission="'/systemConfig/getSystemConfig'" name="five">
        ...
        >
          ...
          <el-form-item label="Minio私钥">
            <el-input v-model="form.minioSecretKey" type="password" auto-complete="new-password" style="width: 400px"/>
          </el-form-item>
      ...
      <el-tab-pane label="仪表盘通知" name="third">
        ...
        <div class="editor-container">
          <CKEditor v-if="form.editorModel == '0'" ref="editor" :content="form.dashboardNotification" :height="500"/>
          <MarkdownEditor v-if="form.editorModel == '1'" ref="editor" :height="660" style="margin-top: 12px"/>
        </div>
