<template>
  <div id="table" class="app-container calendar-list-container">
    ...
    <div class="filter-container" style="margin: 10px 0 10px 0;">
      ...
      <el-button v-permission="'/picture/setCover'" class="filter-item" type="success" icon="el-icon-video-camera-solid" @click="setCover">设为封面</el-button>
    </div>
        ...
        <el-row>
          ...
          >
            <el-card
              ...
              shadow="always"
            >
              <input :id="picture.uid" :checked="pictureUids.indexOf(picture.uid)>=0" style="position: absolute;z-index: 100;" type="checkbox" @click="checked(picture)">
              <el-image
              ...
              <div style="margin-bottom: 14px;">
                <el-button-group>
                  ...
                  <el-tooltip v-permission="'/picture/add'" class="item" effect="dark" content="裁剪图片" placement="bottom-start" style="margin-right: 2px">
                    <el-button
                      type="warning"
                      size="mini"
                      icon="el-icon-s-open"
                  ...
                  <el-tooltip v-permission="'/picture/delete'" class="item" effect="dark" content="删除图片" placement="bottom-start" style="margin-right: 2px">
                    <el-button
                      type="danger"
                      size="mini"
                      icon="el-icon-delete"
    ...
    <el-dialog :visible.sync="pictureCropperVisible" fullscreen>
      <PictureCropper v-if="reFresh" :model-src="checkedPicture.pictureUrl" :file-name="checkedPicture.picName" @cropperSuccess="cropperSuccess"/>
    </el-dialog>
